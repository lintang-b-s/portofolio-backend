...
var putProfile = function putProfile(req, res) {
  var _req$body, name, description, education, image, birthDate, technologies, organizations, projects, activities, profile;

  return regeneratorRuntime.async(function putProfile$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _req$body = req.body, name = _req$body.name, description = _req$body.description, education = _req$body.education, image = _req$body.image, birthDate = _req$body.birthDate, technologies = _req$body.technologies, organizations = _req$body.organizations, projects = _req$body.projects, activities = _req$body.activities;
          _context4.next = 3;
