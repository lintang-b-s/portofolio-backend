...
var postNewOrganization = function postNewOrganization(req, res) {
  var createdOrganization, uploadedResponse;
  return regeneratorRuntime.async(function postNewOrganization$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 6:
          uploadedResponse = _context2.sent;
...
var putOrganizationById = function putOrganizationById(req, res) {
  var _req$body, name, position, date1, date2, images, activities, projects, profile, organization, uploadedResponse;
    ...
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 8:
          ...
          organization.date2 = organization.date2; // if (req.file) {
