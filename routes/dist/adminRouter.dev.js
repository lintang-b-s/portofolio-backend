...
var upload = (0, _multer["default"])(); // const corsOptions = {
...
router.route("/profiles/:id").get(_profile.getProfileById).put(_authenticate.verifyUser, _authenticate.verifyAdmin, _profile.putProfile);
